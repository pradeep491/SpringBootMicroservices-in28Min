...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        //ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
        /*we can return first error with the message also*/
        ...
        /*we can also show  total errors and firt message*/
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(),
                "Total Errors:"+ex.getFieldErrorCount()+" First One is-"+ex.getFieldError().getDefaultMessage(), request.getDescription(false));
